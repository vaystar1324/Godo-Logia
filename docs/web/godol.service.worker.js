...
/** @type {string} */
const CACHE_VERSION = '1779651280|2123102440';
/** @type {string} */
const CACHE_PREFIX = 'GodoLogia-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'godol.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["godol.html","godol.js","godol.offline.html","godol.icon.png","godol.apple-touch-icon.png","godol.audio.worklet.js","godol.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["godol.wasm","godol.pck","godol.side.wasm"];
